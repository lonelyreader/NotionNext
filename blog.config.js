...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'gitbook2', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple,gitbook2
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'A Cohorentist', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.gexu.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://i.postimg.cc/g0CqGXxk/Lonely-Reader-Social-Media-LR-Profile-Brown-BG.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
