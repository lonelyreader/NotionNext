...
export default function CategoryItem ({ selected, category, categoryCount }) {
  return (
    <SmartLink
      ...
      passHref
      className={(selected
        ? 'hover:text-white dark:hover:text-white bg-purple-600 text-white '
        : 'dark:text-purple-400 text-gray-500 hover:text-white dark:hover:text-white hover:bg-purple-600') +
