...
const Footer = ({ siteInfo }) => {
  ...
  return (
    <footer className='z-20 border p-4 rounded-2xl border-yellow-400/20 bg-white/10 backdrop-blur-xl justify-center text-center w-full text-sm relative card'>
      <SocialButton />
