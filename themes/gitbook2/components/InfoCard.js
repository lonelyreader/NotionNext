  ...
  return <div id='info-card' className='py-4 card'>
    <div className='items-center justify-center'>
        <div className='hover:scale-105 transform duration-200 cursor-pointer flex justify-center' onClick={ () => { Router.push('/about') }}>
            <LazyImage src={siteInfo?.icon} className='rounded-full border-2 border-gray-600 shadow-lg' width={120} alt={siteConfig('AUTHOR')}/>
         </div>
        ...
        <div className='font-light text-gray-400 mb-2 hover:scale-105 transform duration-200 flex justify-center'>{siteConfig('BIO')}</div>
        <SocialButton/>
    </div>
  </div>
}
