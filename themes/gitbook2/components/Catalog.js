          ...
          {toc?.map(tocItem => {
            ...
            return (
              <a
                ...
                className={`${activeSection === id && 'border-purple-500 text-purple-500 font-bold'} border-l pl-4 block hover:text-purple-500 border-lduration-300 transform font-light dark:text-gray-300
